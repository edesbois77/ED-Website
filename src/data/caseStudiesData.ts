...
export const detailedCaseStudies: DetailedCaseStudy[] = [
  {
    ...
    client: 'OneFootball',
    logo: 'https://i.imgur.com/0q883hB.jpeg',
    ...
    visuals: {
      hero: 'https://images.pexels.com/photos/460672/pexels-photo-460672.jpeg?auto=compress&cs=tinysrgb&w=1200',
      gallery: [
  ...
  },
  {
    ...
    summary: 'Delivered record-breaking campaign performance through strategic creative direction and cross-platform execution.',
