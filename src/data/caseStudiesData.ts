...
export const detailedCaseStudies: DetailedCaseStudy[] = [
  {
    ...
    summary: 'Repositioned Britain as a must-visit destination for millennial travellers through data-driven content strategy.',
