...
export const products: Product[] = [
  {
    ...
    name: 'Connect-ED™',
    title: '',
    summary: 'dOpen the door to key decision-makers across media, sport and entertainment. A black book constructed over the past 25 years. It’s not just who you know, it’s how you make it matter.',
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      'Puts plans into action with clarity, collaboration and consistency.'
    ],
  ...
  },
  {
    ...
    name: 'Deliver-ED™',
    title: '',
    summary: 'Deliver-ED is built on outcomes. It reflects two decades of exceeding targets, growing teams and driving lasting client success, not once, but time and again.',
    features: [
...
export const caseStudies: CaseStudy[] = [
  ...
  {
    id: '2',
    title: 'EA: Gaming Analytics Revolution',
    description: 'Electronic Arts leveraged ED analytics to increase player engagement by 65%.',
