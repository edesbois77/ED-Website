...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Deliver-ED™',
    title: '',
    summary: 'Achieving what you set out to do isn’t always easy, unless you purchase Deliver-ED. With a track record of exceeding expectations, it helps your business and clients hit goals, raise the bar and outperform time and again.',
    features: [
